...
In the evolving landscape of biostatistics consulting and collaboration within universities and academic medical centers, the financial models underpinning these units are diverse and multifaceted. As highlighted by Hanlon et al. (2022) and Perkins et al. (2016), the funding structures that support collaborative biostatisticians can significantly influence their roles, efficiency, and overall contribution to research projects.<sup class="footnote-ref" id="fnref:sharp"><a href="#fn:sharp">1</a></sup></p>
...
Sharp, J., Griffith, E. H., Craig, B. A., Hanlon, A., Peskoe, S., & Van Mullekom, J. (2024). The current landscape of academic statistical and data science collaboration units with examples. Stat, 13(3), e718.
